...
//
//    /**
//     * Constructs a {@link ProvidedBuilderFactory} instance with given {@link ScopedProviderBuilder} supplier.
//     *
//     * @param supplier the specified {@link ScopedProviderBuilder} supplier, must be non-null
//     */
//    public ProvidedBuilderFactory(Supplier<ScopedProviderBuilder> supplier) {
